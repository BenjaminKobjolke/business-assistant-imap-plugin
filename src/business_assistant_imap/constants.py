...
# Send Later (Thunderbird extension) scheduling
ENV_SEND_LATER_ENABLED = "SEND_LATER_ENABLED"
ENV_SEND_LATER_START_HOUR = "SEND_LATER_START_HOUR"
ENV_SEND_LATER_END_HOUR = "SEND_LATER_END_HOUR"
ENV_USER_TIMEZONE = "USER_TIMEZONE"
DEFAULT_SEND_LATER_START_HOUR = 8
DEFAULT_SEND_LATER_END_HOUR = 18
